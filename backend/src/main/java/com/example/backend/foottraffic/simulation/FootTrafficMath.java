...
public final class FootTrafficMath {
    ...
    /** 64-bit MurmurHash2 variant (fast, stable seed). */
    ...
    /** Box–Muller Gaussian with mean 0, std 1; deterministic from seed. */
    public static double gaussian(long seed) {
        SplittableRandom rnd = new SplittableRandom(seed);
        double u1 = Math.nextUp(rnd.nextDouble()); // avoid log(0)
