  ...
  return (
    <div
      className={cn(
        ...
        scrolled
          ? "border-[color:var(--color-border)] bg-[color:rgba(7,10,18,0.75)] backdrop-blur"
          : "border-transparent bg-transparent",
      )}
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
        <Link href="/" className="flex items-center gap-2">
          <span className="h-8 w-8 rounded-xl bg-[color:var(--color-accent)]" />
        ...
        <button
          type="button"
          className="inline-flex items-center justify-center rounded-xl border border-[color:var(--color-border)] bg-transparent p-2 text-white md:hidden"
      ...
      {open ? (
        <div className="border-t border-[color:var(--color-border)] bg-[color:rgba(7,10,18,0.92)] backdrop-blur md:hidden">
